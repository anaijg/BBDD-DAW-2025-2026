...
# NO. Integridad referencial -> producto.id_fabricante es clave foránea y tiene necesariamente que tener un fabricante.id asociado como clave primaria. (esto viene de la cardinalidad 0..n <-> 1
